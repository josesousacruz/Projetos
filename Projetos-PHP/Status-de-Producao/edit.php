        ...
        <div class="card-body">
            ...
            if (isset($_POST['edit-btn'])) {
                ...
                $stmt = $conection->prepare(
                    "SELECT c.*, p.nome as nome_produto, p.id as produto_id, t.id as transportador_id, t.razao_social as transportador_nome 
                ...
                <form action="code.php" method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="updatebtn" id="updatebtn" class="btn btn-primary"> Editar </button>
