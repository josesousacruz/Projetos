...
<html lang="pt-br">
	...
	<body>
		...
		$query = "SELECT * FROM carregamentos WHERE data_fim BETWEEN :dataInicial AND :dataFinal AND status_carregamento = 'Carregado' ORDER BY data_fim ASC";
		...
		while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
			...
			$html .= '<td>' . $row["id_transportador"] . '</td>';
			$html .= '<td>' . $row["ordemProd"] . '</td>';
