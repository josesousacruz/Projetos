!function (a, b) {
    ...
    function B(a, b, c, d) {
        ...
        // console.log('Current' +c.currentIndex);
        // console.log('Next' +d);
    ...
    function E(b, c, d, e) {
        ...
        /****************************** Removo a classe done do steps anterior qd eu volto **********************************/
        if (d.currentIndex < e) {
            var elements = document.querySelectorAll('.form-register .steps li');
            if (elements[e]) {
                elements[e].classList.remove('done');
            }
        }
